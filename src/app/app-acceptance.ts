...
export const appTransferMode: ToolcraftTransferMode = {
  animationIntent: {
    loopDuration: {
      evidence:
        "Every sweep pattern (wave/curtain/fan/radial) is expressed as an integer number of cycles over the loop progress, so the loop period is a product-derived choice, not a reference timing or user-specified duration. 6 seconds was chosen as a readable default sweep length for a halftone reveal at the default Speed of 2 cycles.",
      seconds: 6,
...
export const appProductReadiness: ToolcraftProductReadiness = {
  mode: "product",
  productName: "Pixel Sweep",
  productSummary:
    "A generative halftone-style visual effect: a circular grid of small squares that independently toggle between filled (on) and hollow outline (off) states as a user-selectable sweep pattern travels across the grid in a seamless forward-looping animation.",
  requestedBehavior:
    "Render a circular silhouette made of a grid of squares on a solid background. Squares outside the circle are absent. Each square toggles between a solid filled 'on' state and a hollow outline 'off' state as one of four sweep patterns (diagonal Wave, straight Curtain wipe with horizontal/vertical direction and forward/reverse, rotating radar-style Fan, or expanding Radial Pulse rings) travels across the grid, looping forward seamlessly. The grid density, square gap, on/off colors, and sweep speed are user-controllable, and the result can be exported as a still PNG or a looping video.",
};

const halftoneControlAcceptance: readonly ToolcraftComponentAcceptance[] = [
  {
    automated: true,
    automatedTestName: "pattern.mode changes the rendered sweep math",
    browser: true,
    browserTestName: "browser: pattern select changes product output",
    componentType: "select",
    evidence: "product-output",
    expectedObservable:
      "Selecting Wave, Curtain, Fan, Fan 3, Radial Pulse, or Random changes which squares are currently on/off in the rendered canvas.",
    fixture: "circle grid default state",
    id: "pattern.mode",
    kind: "control",
    optionCoverage: "each-visible-item",
    target: "pattern.mode",
    userAction: "Open the Pattern select and choose Wave, Curtain, Fan, Fan 3, Radial Pulse, and Random in turn.",
  },
  {
    automated: true,
    automatedTestName: "pattern.direction changes the curtain sweep axis and is hidden outside curtain mode",
    browser: true,
    browserTestName: "browser: direction segmented changes curtain axis and hides outside curtain mode",
    componentType: "segmented",
    evidence: "product-output",
    expectedObservable:
      "Direction is hidden while Pattern is Wave, Fan, or Radial Pulse and becomes visible/shown once Pattern is set to Curtain; with Pattern set to Curtain, switching Direction between Horizontal and Vertical changes which axis the wipe band travels along, changing the rendered on/off pattern.",
    ...
    userAction:
      "Confirm Direction is not shown for Wave, switch Pattern to Curtain and confirm Direction appears, then click the Horizontal and Vertical segmented options and compare rendered output.",
  },
  {
    automated: true,
    automatedTestName: "pattern.reverse flips the curtain travel direction and is hidden outside curtain mode",
    browser: true,
    browserTestName: "browser: reverse switch flips curtain travel direction and hides outside curtain mode",
    componentType: "switch",
    evidence: "product-output",
    expectedObservable:
      "Reverse is hidden while Pattern is Wave, Fan, or Radial Pulse and becomes visible/shown once Pattern is set to Curtain; with Pattern set to Curtain, toggling Reverse flips which side of the grid the wipe band starts from, changing the rendered on/off pattern at a fixed timeline time.",
    fixture: "curtain pattern default state",
    id: "pattern.reverse",
    kind: "control",
    target: "pattern.reverse",
    userAction:
      "Confirm Reverse is not shown for Wave, switch Pattern to Curtain and confirm Reverse appears, then toggle Reverse on and off and compare rendered output.",
  },
  {
    automated: true,
    automatedTestName: "pattern.speed changes sweep cycles per loop",
    browser: true,
    browserTestName: "browser: speed slider changes product output live while dragging",
    componentType: "slider",
    evidence: "product-output",
    expectedObservable:
      "Dragging Speed changes how many sweep cycles complete during one timeline loop, changing the rendered on/off pattern at a fixed timeline time while the thumb is still being dragged.",
    fixture: "circle grid default state",
    id: "pattern.speed",
    kind: "control",
    target: "pattern.speed",
    userAction: "Drag the Speed slider thumb and observe the canvas update during the drag.",
  },
  {
    automated: true,
    automatedTestName: "grid.columns changes the number of rendered squares",
    browser: true,
    browserTestName: "browser: columns slider changes product output live while dragging",
    componentType: "slider",
    evidence: "product-output",
    expectedObservable:
      "Dragging Columns changes how many squares are generated across the circular silhouette, changing the rendered canvas during the drag.",
    fixture: "circle grid default state",
    id: "grid.columns",
    kind: "control",
    target: "grid.columns",
    userAction: "Drag the Columns slider thumb and observe the canvas update during the drag.",
  },
  {
    automated: true,
    automatedTestName: "grid.gap changes the square size and spacing",
    browser: true,
    browserTestName: "browser: gap slider changes product output live while dragging",
    componentType: "slider",
    evidence: "product-output",
    expectedObservable:
      "Dragging Gap changes the per-cell spacing percentage and therefore each square's rendered size, changing the canvas during the drag.",
    fixture: "circle grid default state",
    id: "grid.gap",
    kind: "control",
    target: "grid.gap",
    userAction: "Drag the Gap slider thumb and observe the canvas update during the drag.",
  },
  {
    automated: true,
    automatedTestName: "grid.jitter offsets squares deterministically without leaving their cells",
    browser: true,
    browserTestName: "browser: jitter slider changes product output live while dragging",
    componentType: "slider",
    evidence: "product-output",
    expectedObservable:
      "Dragging Jitter pushes every square off its grid alignment by a stable per-cell offset, visibly scattering the layout during the drag.",
    fixture: "circle grid default state",
    id: "grid.jitter",
    kind: "control",
    target: "grid.jitter",
    userAction: "Drag the Jitter slider thumb and observe the squares scatter during the drag.",
  },
  {
    automated: false,
    automatedTestName: "",
    browser: true,
    browserTestName:
      "browser: resolution scale discrete slider renders the discrete variant with markers",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Dragging Resolution scale between its discrete steps changes the preview canvas backing-store resolution while the layout size stays fixed.",
    fixture: "circle grid default state",
    id: "canvas.renderScale",
    kind: "control",
    target: "canvas.renderScale",
    userAction:
      "Hover the Resolution scale slider in Setup to reveal its step markers, then drag the thumb across discrete steps.",
  },
  {
    automated: true,
    automatedTestName: "style.onColor changes filled square color",
    browser: true,
    browserTestName: "browser: on color control changes filled square color",
    componentType: "color",
    evidence: "product-output",
    expectedObservable: "Changing On Color changes the fill color of every currently-on square.",
    fixture: "circle grid default state",
    id: "style.onColor",
    kind: "control",
    target: "style.onColor",
    userAction: "Open the On Color picker and change the hex value.",
  },
  {
    automated: true,
    automatedTestName: "style.offColor changes hollow square outline color and opacity",
    browser: true,
    browserTestName: "browser: off color control changes hollow square outline color and opacity",
    componentType: "colorOpacity",
    controlPartCoverage: ["colorOpacity.hex", "colorOpacity.opacity"],
    evidence: "product-output",
    expectedObservable:
      "Changing Off Color's hex or opacity changes the stroke color/alpha of every currently-off square.",
    fixture: "circle grid default state",
    id: "style.offColor",
    kind: "control",
    target: "style.offColor",
    userAction: "Open Off Color and change both the hex value and the opacity value.",
  },
  {
    automated: true,
    automatedTestName: "export.includeBackground hides the live preview background and creates a transparent PNG",
    browser: true,
    browserTestName: "browser: include toggle hides preview background and PNG stays transparent",
    componentType: "switch",
    evidence: "product-output",
    expectedObservable:
      "Turning Include off hides the rendered canvas background in the live preview and produces a transparent PNG export; turning it on restores the background and keeps the video export background regardless of Include.",
    fixture: "circle grid default state",
    id: "export.includeBackground",
    kind: "control",
    target: "export.includeBackground",
    userAction:
      "Toggle Include off and confirm the preview background is hidden and PNG export is transparent, then toggle it on and confirm PNG background returns and video export always keeps the background.",
  },
  {
    automated: true,
    automatedTestName: "scene.background changes the rendered background color",
    browser: true,
    browserTestName: "browser: background color control changes canvas fill",
    componentType: "color",
    evidence: "product-output",
    expectedObservable: "Changing the Background color updates the solid canvas fill behind the grid.",
    fixture: "circle grid default state",
    id: "scene.background",
    kind: "control",
    target: "scene.background",
    userAction: "Open the Background color control and change the hex value.",
  },
  {
    automated: true,
    automatedTestName: "export.image.format switches between PNG and JPG output",
    browser: true,
    browserTestName: "browser: image format select changes exported file type",
    componentType: "select",
    evidence: "exported-bytes",
    expectedObservable: "Choosing PNG vs JPG changes the exported image MIME type/bytes.",
    fixture: "Image Export section default state",
    id: "export.image.format",
    kind: "control",
    optionCoverage: "each-visible-item",
    target: "export.image.format",
    userAction: "Select PNG, export, then select JPG, and export again.",
  },
  {
    automated: true,
    automatedTestName: "export.image.resolution changes exported pixel dimensions",
    browser: true,
    browserTestName: "browser: image resolution select changes exported pixel dimensions",
    componentType: "select",
    evidence: "exported-bytes",
    expectedObservable:
      "Choosing 2K, 4K, or 8K changes the decoded long-edge pixel dimensions of the exported PNG.",
    fixture: "Image Export section at each resolution",
    id: "export.image.resolution",
    kind: "control",
    optionCoverage: "each-visible-item",
    target: "export.image.resolution",
    userAction: "Select 2K and export, then select 4K and export, then select 8K and export.",
  },
  {
    automated: true,
    automatedTestName: "export.video.format switches between MP4 and WebM output",
    browser: true,
    browserTestName: "browser: video format select changes exported container/mime",
    componentType: "select",
    evidence: "exported-bytes",
    expectedObservable:
      "Choosing MP4 vs WebM changes the requested export container; unsupported combinations fall back to a supported MediaRecorder MIME type instead of failing.",
    fixture: "Video Export section default state",
    id: "export.video.format",
    kind: "control",
    optionCoverage: "each-visible-item",
    target: "export.video.format",
    userAction: "Select MP4, export a short video, then select WebM, and export again.",
  },
  {
    automated: true,
    automatedTestName: "export.video.resolution changes exported video pixel dimensions",
    browser: true,
    browserTestName: "browser: video resolution select changes exported video pixel dimensions",
    componentType: "select",
    evidence: "exported-bytes",
    expectedObservable:
      "Choosing Current vs 4K changes the decoded videoWidth/videoHeight of the exported video, using getToolcraftVideoExportSize even-dimension rounding.",
    fixture: "Video Export section at Current and 4K",
    id: "export.video.resolution",
    kind: "control",
    optionCoverage: "each-visible-item",
    target: "export.video.resolution",
    userAction: "Select Current and export, then select 4K and export.",
  },
  {
    actionCoverage: ["export.video", "export.png"],
    automated: true,
    automatedTestName: "sticky footer actions export video and PNG output",
    browser: true,
    browserTestName: "browser: sticky footer exports video and PNG with progress",
    componentType: "panelActions",
    evidence: "exported-bytes",
    expectedObservable:
      "Clicking Export Video produces a downloadable video blob with duration matching the timeline; clicking Export PNG produces a downloadable PNG blob. Both show the sticky footer pending indicator while the export Promise is in flight.",
    fixture: "circle grid default state",
    id: "panel.actions",
    kind: "control",
    target: "panel.actions",
    userAction: "Click Export Video, wait for it to complete, then click Export PNG and wait for it to complete.",
  },
  {
    automated: true,
    ...
    expectedObservable:
      "The timeline transport changes runtime playback state; editing the timeline duration changes the playback range while the rendered sweep still advances in one direction with no mirror, no yoyo, and no ping-pong, direction does not reverse, and the first and last frames stitch with no visible jump even after changing duration, and scrubbing changes the rendered on/off pattern.",
    fixture: "playback timeline fixture",
    ...
    userAction:
      "Play and pause the timeline, scrub to different times, then edit the timeline duration and confirm playback still advances in one direction with no mirror, no yoyo, and no ping-pong, direction does not reverse, and the first and last frames stitch with no visible jump.",
  },
];

export const appAcceptance: readonly ToolcraftComponentAcceptance[] = halftoneControlAcceptance;

export const starterControlSectionInventory: readonly ToolcraftControlSectionInventoryEntry[] = [
  {
    entity: "Sweep pattern",
    groupingReason:
      "Pattern mode, its Curtain-only direction/reverse options, and sweep speed all configure the single sweep behavior that toggles squares on and off.",
    targets: ["pattern.mode", "pattern.direction", "pattern.reverse", "pattern.speed"],
    title: "Pattern",
  },
  {
    entity: "Square grid layout",
    groupingReason:
      "Columns, Gap, and Jitter all control how the circular grid of squares is laid out before any pattern is applied.",
    targets: ["grid.columns", "grid.gap", "grid.jitter"],
    title: "Grid",
  },
  {
    entity: "On/off square appearance",
    groupingReason:
      "On Color and Off Color configure the two visual states every square can be in.",
    targets: ["style.onColor", "style.offColor"],
    title: "Squares",
  },
  {
    entity: "Output background",
    groupingReason:
      "The required Background section pairs the Include switch with the unlabeled background color for the same product background entity.",
    targets: ["export.includeBackground", "scene.background"],
    title: "Background",
  },
  {
    entity: "Still image export settings",
    groupingReason: "Format and Resolution both configure the PNG export output.",
    targets: ["export.image.format", "export.image.resolution"],
    title: "Image Export",
  },
  {
    entity: "Video export settings",
    groupingReason: "Format and Resolution both configure the video export output.",
